...
print(f"{'='*70}")
print(f"Engine Comparison Test - Vision API vs GPT-4o-mini")
print(f"{'='*70}")
print(f"Specimens to test: {len(image_hashes)}")
print(f"Schema: Darwin Core v2.0 (16 fields)")
print(f"Prompts: image_to_dwc_v2 (layout-aware)")
print(f"{'='*70}\n")
...
print(f"   python cli.py process --input {image_dir} --output {gpt4omini_output} --engine gpt4omini")

print("\\n3. Compare results:")
print(f"   python analyze_comparison.py")
